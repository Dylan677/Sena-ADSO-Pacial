...
-- --------------------------------------------------------
--
-- Actualización de contraseña para usuario de prueba
-- Contraseña en texto plano: Admin123*
-- Hash generado con bcrypt (10 rounds)
--

UPDATE `users`
SET `User_password` = '$2b$10$nbxi17aQK1lllUjJ6RR0ReglfVjYm2CPqgQw/bxkM2e16OX/UWk5e'
WHERE `User_email` = 'd.casallas@gmail.com';